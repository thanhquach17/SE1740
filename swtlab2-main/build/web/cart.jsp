                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 tm-faq" style="margin-left: 0px">
                                <div class="d-flex flex-wrap justify-content-between align-items-center pb-4" vertical-align: middle>
                                    <div class="accordion" >Choose place to eat</div>
                                        <div class="form-group">
            ...
            <footer class="tm-footer">
                <div class="tm-address">
                    ...
                    <a href="tel:0395931502" class="tm-contact-link">
                        <i class="fas fa-phone tm-contact-icon"></i>0123456789
                    </a>
                    <a href="mailto:no.72bylc@gmail.com" class="tm-contact-link">
                        <i class="fas fa-envelope tm-contact-icon"></i>quan@gmail.com
                    </a>
